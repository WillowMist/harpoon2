...
class ManagerModalForm(ModalModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # each field's widget so the managercreate.html template can toggle
        # visibility per managertype.
