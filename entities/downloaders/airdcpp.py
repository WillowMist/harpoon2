                ...
                if 'has finished downloading' in text.lower():
                    if text.startswith('The bundle '):
                        ...
                        try:
                            ...
                            # Skip already-completed items - don't re-process them on restart
                            if item.status == 'Completed':
                                logger.debug(f"AirDC++: Skipping already completed item {item.name}")
    ...
    def get_download_info(self, hash: str) -> dict:
        ...
        try:
            ...
            if is_bundle:
                ...
                # For individual files, return single file info
                return {
